...
fit_one_expo.SetLineColor(2)
fit_one_expo.Draw("SAME")
fit_two_expo.SetLineColor(3)
fit_two_expo.Draw("SAME")
fit_three_expo.SetLineColor(4)
fit_three_expo.Draw("SAME")
...
print "Ok 5 I got here to draw tec histo"
