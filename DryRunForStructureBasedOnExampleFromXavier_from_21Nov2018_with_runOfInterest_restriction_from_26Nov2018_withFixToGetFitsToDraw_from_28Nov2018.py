...
h_nclusters_vs_time = ROOT.TH1F("nclusters_vs_time", "nClusters vs. Time for %s; Time (Lumi Sections); nClusters"%(fileName), 1000, 0, 1000) #For the whole strips tracker
h_nclusters_vs_time_tid = ROOT.TH1F("nclusters_vs_time_tid", "nClusters vs. Time in the TID for %s; Time (Lumi Sections); nClusters" %(fileName), 1000, 0, 1000) # for TID
h_nclusters_vs_time_tec = ROOT.TH1F("nclusters_vs_time_tec", "nClusters vs. Time in the TEC for %s; Time (Lumi Sections); nClusters" %(fileName), 1000, 0, 1000) # for TEC
...
#Ending up defining this stuff later so that I could fit just to the bins that actually got filled...in other words, so I could fix the problem I indicated with my FIX ME RE: 0,1000
...
#Get the first and last filled bins for each histogram so we know what range to fit over...
h_nclusters_vs_time.FindFirstBinAbove(0)
print 'WILDCAT! First bin above 0 for h_nclusters_vs_time is:', h_nclusters_vs_time.FindFirstBinAbove(0)
h_nclusters_vs_time.FindLastBinAbove(0)
print 'SUNFISH! Last bin above 0 for h_nclusters_vs_time is:', h_nclusters_vs_time.FindLastBinAbove(0)
#Recall that the bin size is 1 LS, so the way to get where you are on the x axis is just bin_size * number bin you are at aka 1 * number bin you are at aka number bin you are at...

lower_bound =  h_nclusters_vs_time.FindFirstBinAbove(0)
upper_bound =  h_nclusters_vs_time.FindLastBinAbove(0)

print 'lower_bound is:', lower_bound
print 'upper_bound is:', upper_bound

h_nclusters_vs_time_tid.FindFirstBinAbove(0)
print 'AGGIES! First bin above 0 for h_nclusters_vs_time_tid is:', h_nclusters_vs_time_tid.FindFirstBinAbove(0)
h_nclusters_vs_time_tid.FindLastBinAbove(0)
print 'LONGHORNS! Last bin above 0 for h_nclusters_vs_time_tid is:', h_nclusters_vs_time_tid.FindLastBinAbove(0)

lower_bound_tid = h_nclusters_vs_time_tid.FindFirstBinAbove(0)
upper_bound_tid = h_nclusters_vs_time_tid.FindLastBinAbove(0)
print "type lower_bound_tid is:", type(lower_bound_tid)

print 'lower_bound_tid is:', lower_bound_tid
print 'upper_bound_tid is:', upper_bound_tid

h_nclusters_vs_time_tec.FindFirstBinAbove(0)
print 'RAIDERS! First bin above 0 for h_nclusters_vs_time_tec is:', h_nclusters_vs_time_tec.FindFirstBinAbove(0)
h_nclusters_vs_time_tec.FindLastBinAbove(0)
print 'BEARS! Last bin above 0 for h_nclusters_vs_time_tec is:', h_nclusters_vs_time_tec.FindLastBinAbove(0)

lower_bound_tec = h_nclusters_vs_time_tec.FindFirstBinAbove(0)
upper_bound_tec = h_nclusters_vs_time_tec.FindLastBinAbove(0)

print 'lower_bound_tec is:', lower_bound_tec
print 'upper_bound_tec is:', upper_bound_tec

#Defining fitting functions (including the ranges)

fit_one_expo = ROOT.TF1("fit_one_expo", my_expo, lower_bound -1., upper_bound, 2)  #FIX ME RE: 0,1000...I think fixed with lower_bound, upper_bound convention
fit_two_expo = ROOT.TF1("fit_two_expo", my_sum_of_two_expo, lower_bound -1., upper_bound, 4)
fit_three_expo = ROOT.TF1("fit_three_expo", my_sum_of_three_expo, lower_bound -1., upper_bound, 6)
print "At fit_one_expo, fit_two_expo, fit_three_expo, I am ok"
print "switching to lower_bound, upper_bound is ok!"

fit_one_expo_tid = ROOT.TF1("fit_one_expo_tid", my_expo, lower_bound_tid -1., upper_bound_tid, 2)
fit_two_expo_tid = ROOT.TF1("fit_two_expo_tid", my_sum_of_two_expo, lower_bound_tid -1., upper_bound_tid, 4)
fit_three_expo_tid = ROOT.TF1("fit_three_expo_tid", my_sum_of_three_expo, lower_bound_tid -1., upper_bound_tid, 6)
print "At fit_one_expo_tid, fit_two_expo_tid, fit_three_expo_tid, I am ok"
print "Switching to lower_bound_tid, upper_bound_tid is ok!"

fit_one_expo_tec = ROOT.TF1("fit_one_expo_tec", my_expo, lower_bound_tec -1., upper_bound_tec, 2)
fit_two_expo_tec = ROOT.TF1("fit_two_expo_tec", my_sum_of_two_expo, lower_bound_tec -1., upper_bound_tec, 4)
fit_three_expo_tec = ROOT.TF1("fit_three_expo_tec", my_sum_of_three_expo, lower_bound_tec -1., upper_bound_tec, 6)

print "At_fit_one_expo_tec, fit_two_expo_tec, fit_three_expo_tec, I am ok!"
print "Switching to lower_bound_tec, upper_bound_tec is ok!"
...
myFileOneExpo = open(fileName + "_" + str(runOfInterest)  +'_WholeTracker_OneExpo.txt', 'w')
sys.stdout = myFileOneExpo
print "ChiSquare  :", fit_one_expo.GetChisquare()
print "NDF        :", fit_one_expo.GetNDF()
print "CS/NDF     :", fit_one_expo.GetChisquare()/fit_one_expo.GetNDF()
...
fit_one_expo_to_draw = ROOT.TF1("fit_one_expo_to_draw", "TMath::Exp((%s) + (%s)*x)"%(par0_fit_one_expo_string,par1_fit_one_expo_string), lower_bound -1., upper_bound)
print "PENGUIN! changing to lower_bound, upper_bound in fit_one_expo_to_draw is ok!"
print '####'
...
orig_stdout = sys.stdout
myFileTwoExpo = open(fileName + "_" + str(runOfInterest)  + '_WholeTracker_TwoExpo.txt', 'w')
sys.stdout = myFileTwoExpo
print "ChiSquare  :", fit_two_expo.GetChisquare()
print "NDF        :", fit_two_expo.GetNDF()
print "CS/NDF     :", fit_two_expo.GetChisquare()/fit_two_expo.GetNDF()
...
fit_two_expo_to_draw = ROOT.TF1("fit_two_expo_to_draw", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_two_expo_string,par1_fit_two_expo_string, par2_fit_two_expo_string, par3_fit_two_expo_string), lower_bound -1., upper_bound)
print "switching to lower_bound, upper_bound for fit_two_expo_to_draw is ok!"
print "######"
...
orig_stdout = sys.stdout
myFileThreeExpo = open(fileName + "_" + str(runOfInterest) + '_WholeTracker_ThreeExpo.txt', 'w')
sys.stdout = myFileThreeExpo
print "ChiSquare  :", fit_three_expo.GetChisquare()
print "NDF        :", fit_three_expo.GetNDF()
print "CS/NDF     :", fit_three_expo.GetChisquare()/fit_three_expo.GetNDF()
...
fit_three_expo_to_draw = ROOT.TF1("fit_three_expo_to_draw", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_three_expo_string,par1_fit_three_expo_string, par2_fit_three_expo_string, par3_fit_three_expo_string, par4_fit_three_expo_string, par5_fit_three_expo_string), lower_bound -1., upper_bound)
print "switching to lower_bound, upper_bound in fit_three_expo_to_draw is ok!!"
print "####"
...
orig_stdout = sys.stdout
myFileOneExpo = open(fileName + "_" + str(runOfInterest) +'_TIDTracker_OneExpo.txt', 'w')
sys.stdout = myFileOneExpo
print "ChiSquare  :", fit_one_expo_tid.GetChisquare()
print "NDF        :", fit_one_expo_tid.GetNDF()
print "CS/NDF     :", fit_one_expo_tid.GetChisquare()/fit_one_expo_tid.GetNDF()
...
#Begin manipulations to get the parameters from the fit into a new function that I can actually have drawn for the fit_one_expo_tid
par0_fit_one_expo_tid = fit_one_expo_tid.GetParameter(0)
par1_fit_one_expo_tid = fit_one_expo_tid.GetParameter(1)
print "par0_fit_one_expo_tid is:", par0_fit_one_expo_tid
print "par1_fit_one_expo_tid is:", par1_fit_one_expo_tid
par0_fit_one_expo_string_tid = str(fit_one_expo_tid.GetParameter(0))
par1_fit_one_expo_string_tid = str(fit_one_expo_tid.GetParameter(1))
print 'par0_fit_one_expo_string_tid is:', par0_fit_one_expo_string_tid
print 'par1_fit_one_expo_string_tid is:', par1_fit_one_expo_string_tid
#fit_one_expo_to_draw = ROOT.TF1("fit_one_expo_to_draw", fit_one_expo, 0, 1000)
fit_one_expo_to_draw_tid = ROOT.TF1("fit_one_expo_to_draw_tid", "TMath::Exp((%s) + (%s)*x)"%(par0_fit_one_expo_string_tid,par1_fit_one_expo_string_tid), lower_bound_tid -1., upper_bound_tid)
print "switching to lower_bound_tid, upper_bound_tid in fit_one_expo_to_draw_tid is ok!"
print "###"
print "checking again and having it print again, par0_fit_one_expo_tid is:", par0_fit_one_expo_tid
print "checking again and having it print again, par1_fit_one_expo_tid is:", par1_fit_one_expo_tid
print "checking again and having it print again, par0_fit_one_expo_string_tid is:", par0_fit_one_expo_string_tid
print "checking again and having it print again, par1_fit_one_expo_string is:", par1_fit_one_expo_string_tid
print "fit_one_expo_to_draw_tid is:", fit_one_expo_to_draw_tid
print "I reached where Mary has defined fit_one_expo_to_draw_tid!!"
...
orig_stdout = sys.stdout
myFileTwoExpo = open(fileName + "_" + str(runOfInterest) +'_TIDTracker_TwoExpo.txt', 'w')
sys.stdout = myFileTwoExpo
print "ChiSquare  :", fit_two_expo_tid.GetChisquare()
print "NDF        :", fit_two_expo_tid.GetNDF()
print "CS/NDF     :", fit_two_expo_tid.GetChisquare()/fit_two_expo_tid.GetNDF()
...
par0_fit_two_expo_tid = fit_two_expo_tid.GetParameter(0)
par1_fit_two_expo_tid = fit_two_expo_tid.GetParameter(1)
par2_fit_two_expo_tid = fit_two_expo_tid.GetParameter(2)
par3_fit_two_expo_tid = fit_two_expo_tid.GetParameter(3)
print "par0_fit_two_expo_tid is:", par0_fit_two_expo_tid
print "par1_fit_two_expo_tid is:", par1_fit_two_expo_tid
print "par2_fit_two_expo_tid is:", par2_fit_two_expo_tid
print "par3_fit_two_expo_tid is:", par3_fit_two_expo_tid
par0_fit_two_expo_string_tid = str(fit_two_expo_tid.GetParameter(0))
par1_fit_two_expo_string_tid = str(fit_two_expo_tid.GetParameter(1))
par2_fit_two_expo_string_tid = str(fit_two_expo_tid.GetParameter(2))
par3_fit_two_expo_string_tid = str(fit_two_expo_tid.GetParameter(3))
print 'par0_fit_two_expo_string_tid is:', par0_fit_two_expo_string_tid
print 'par1_fit_two_expo_string_tid is:', par1_fit_two_expo_string_tid
print "par2_fit_two_expo_string_tid is:", par2_fit_two_expo_string_tid
print "par3_fit_two_expo_string_tid is:", par3_fit_two_expo_string_tid

fit_two_expo_to_draw_tid = ROOT.TF1("fit_two_expo_to_draw_tid", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_two_expo_string_tid, par1_fit_two_expo_string_tid, par2_fit_two_expo_string_tid, par3_fit_two_expo_string_tid), lower_bound_tid -1., upper_bound_tid)
print "switching to lower_bound_tid, upper_bound_tid for fit_two_expo_to_draw_tid is ok!"
print "####"
print "DONKEY! I have reached the place where Mary defined fit_two_expo_to_draw_tid!"

#Executive decision, not trying the triple sum of exponentials for the TID or TEC, the double is already having some convergence problems...
...
orig_stdout = sys.stdout
myFileOneExpo = open(fileName + "_" + str(runOfInterest) + '_TECTracker_OneExpo.txt', 'w')
sys.stdout = myFileOneExpo
print "ChiSquare  :", fit_one_expo_tec.GetChisquare()
print "NDF        :", fit_one_expo_tec.GetNDF()
print "CS/NDF     :", fit_one_expo_tec.GetChisquare()/fit_one_expo_tec.GetNDF()
...
#Begin manipulations to get fit_one_expo_to_draw_tec
par0_fit_one_expo_tec = fit_one_expo_tec.GetParameter(0)
par1_fit_one_expo_tec = fit_one_expo_tec.GetParameter(1)
print "par0_fit_one_expo_tec is:", par0_fit_one_expo_tec
print "par1_fit_one_expo_tec is:", par1_fit_one_expo_tec
par0_fit_one_expo_string_tec = str(fit_one_expo_tec.GetParameter(0))
par1_fit_one_expo_string_tec = str(fit_one_expo_tec.GetParameter(1))
print 'par0_fit_one_expo_string_tec is:', par0_fit_one_expo_string_tec
print 'par1_fit_one_expo_string_tec is:', par1_fit_one_expo_string_tec
#fit_one_expo_to_draw = ROOT.TF1("fit_one_expo_to_draw", fit_one_expo, 0, 1000)
fit_one_expo_to_draw_tec = ROOT.TF1("fit_one_expo_to_draw_tec", "TMath::Exp((%s) + (%s)*x)"%(par0_fit_one_expo_string_tec,par1_fit_one_expo_string_tec), lower_bound_tec -1., upper_bound_tec)
print "switching to lower_bound_tec, upper_bound_tec for fit_one_expo_to_draw_tec is ok!"
print "###"
print "I have reached the part where Mary defines fit_one_expo_to_draw_tec! KOALA!"
...
orig_stdout = sys.stdout
myFileTwoExpo = open(fileName + "_" + str(runOfInterest) +'_TECTracker_TwoExpo.txt', 'w')
sys.stdout = myFileTwoExpo
print "ChiSquare  :", fit_two_expo_tec.GetChisquare()
print "NDF        :", fit_two_expo_tec.GetNDF()
print "CS/NDF     :", fit_two_expo_tec.GetChisquare()/fit_two_expo_tec.GetNDF()
...
#Begin manipulations to get the fit_two_expo_to_draw_tec
par0_fit_two_expo_tec = fit_two_expo_tec.GetParameter(0)
par1_fit_two_expo_tec = fit_two_expo_tec.GetParameter(1)
par2_fit_two_expo_tec = fit_two_expo_tec.GetParameter(2)
par3_fit_two_expo_tec = fit_two_expo_tec.GetParameter(3)
print "par0_fit_two_expo_tec is:", par0_fit_two_expo_tec
print "par1_fit_two_expo_tec is:", par1_fit_two_expo_tec
print "par2_fit_two_expo_tec is:", par2_fit_two_expo_tec
print "par3_fit_two_expo_tec is:", par3_fit_two_expo_tec
par0_fit_two_expo_string_tec = str(fit_two_expo_tec.GetParameter(0))
par1_fit_two_expo_string_tec = str(fit_two_expo_tec.GetParameter(1))
par2_fit_two_expo_string_tec = str(fit_two_expo_tec.GetParameter(2))
par3_fit_two_expo_string_tec = str(fit_two_expo_tec.GetParameter(3))
print 'par0_fit_two_expo_string_tec is:', par0_fit_two_expo_string_tec
print 'par1_fit_two_expo_string_tec is:', par1_fit_two_expo_string_tec
print "par2_fit_two_expo_string_tec is:", par2_fit_two_expo_string_tec
print "par3_fit_two_expo_string_tec is:", par3_fit_two_expo_string_tec

fit_two_expo_to_draw_tec = ROOT.TF1("fit_two_expo_to_draw_tec", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_two_expo_string_tec, par1_fit_two_expo_string_tec, par2_fit_two_expo_string_tec, par3_fit_two_expo_string_tec), lower_bound_tec -1., upper_bound_tec)
print "switching to lower_bound_tec, upper_bound_tec for fit_two_expo_to_draw_tec is ok!!"
print "#####"


####doing a sanity check###
for i in xrange(0,1001):
    print "bin %s for h_nclusters_vs_time has bin content %s" %(i, h_nclusters_vs_time.GetBinContent(i))
...
h_nclusters_vs_time.SetAxisRange(lower_bound -10., upper_bound + 10., "X")
...
c3.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit.pdf')
c3.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit.png')
c3.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit.eps')
c3.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit.root')
print "Ok, got here to draw whole tracker histo!"

c4 = ROOT.TCanvas()
ROOT.gStyle.SetOptStat(0)
h_nclusters_vs_time_tid.SetAxisRange(lower_bound_tid - 10., upper_bound_tid + 10., "X")
h_nclusters_vs_time_tid.Draw()
fit_one_expo_to_draw_tid.SetLineColor(2)
fit_one_expo_to_draw_tid.Draw("SAME")
fit_two_expo_to_draw_tid.SetLineColor(3)
fit_two_expo_to_draw_tid.Draw("SAME")
#fit_three_expo_tid.SetLineColor(4)
#fit_three_expo_tid.Draw("SAME")
c4.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit_tid.pdf')
c4.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit_tid.png')
c4.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit_tid.eps')
c4.SaveAs(fileName + "_" + str(runOfInterest)  + '_nclusters_vs_time_histo_fit_tid.root')

print "Ok 4 I got here to draw tid histo"

c5 = ROOT.TCanvas()
ROOT.gStyle.SetOptStat(0)
h_nclusters_vs_time_tec.SetAxisRange(lower_bound_tec - 10., upper_bound_tec + 10., "X")
print "lower_bound_tec -10. is:", lower_bound_tec -10.
print "upper_bound_tec + 10. is:", upper_bound_tec + 10.
h_nclusters_vs_time_tec.Draw()
fit_one_expo_to_draw_tec.SetLineColor(2)
fit_one_expo_to_draw_tec.Draw("SAME")
fit_two_expo_to_draw_tec.SetLineColor(3)
fit_two_expo_to_draw_tec.Draw("SAME")
