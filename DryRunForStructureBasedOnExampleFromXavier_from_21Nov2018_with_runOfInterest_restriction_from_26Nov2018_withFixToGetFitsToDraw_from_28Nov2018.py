...
#fit_one_expo_to_draw = ROOT.TF1("fit_one_expo_to_draw", fit_one_expo, 0, 1000)
fit_one_expo_to_draw_tid = ROOT.TF1("fit_one_expo_to_draw_tid", "TMath::Exp((%s) + (%s)*x)"%(par0_fit_one_expo_string_tid,par1_fit_one_expo_string_tid), 0, 1000)
...
fit_two_expo_to_draw_tid = ROOT.TF1("fit_two_expo_to_draw_tid", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_two_expo_string_tid, par1_fit_two_expo_string_tid, par2_fit_two_expo_string_tid, par3_fit_two_expo_string_tid), 0, 1000)
...
#fit_one_expo_to_draw = ROOT.TF1("fit_one_expo_to_draw", fit_one_expo, 0, 1000)
fit_one_expo_to_draw_tec = ROOT.TF1("fit_one_expo_to_draw_tec", "TMath::Exp((%s) + (%s)*x)"%(par0_fit_one_expo_string_tec,par1_fit_one_expo_string_tec), 0, 1000)
...
fit_two_expo_to_draw_tec = ROOT.TF1("fit_two_expo_to_draw_tec", "TMath::Exp((%s) + (%s)*x) +TMath::Exp((%s) + (%s)*x)"%(par0_fit_two_expo_string_tec, par1_fit_two_expo_string_tec, par2_fit_two_expo_string_tec, par3_fit_two_expo_string_tec), 0, 1000)
